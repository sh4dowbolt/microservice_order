...
public class CustomerOrderException extends AbstractThrowableProblem {
    public CustomerOrderException(final String uuid, final String reason) {
        super(ErrorConstants.CUSTOMER_MICROSERVICE, "Customer Microservice Error", INTERNAL_SERVER_ERROR, String.format("For Order UUID: %s, Customer Microservice Message: %s", uuid, reason));
    }
